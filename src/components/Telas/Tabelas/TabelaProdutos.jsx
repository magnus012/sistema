...
export default function TabelaProdutos(props) {
  ...
  function excluirProduto(produto) {
    if (window.confirm("Deseja realmente excluir o produto" + produto.descricao)) {
      ...
      //abordagem elementar
      /*let novaLista =[]
      for (let i=0; i< props.listaProdutos.lenght;i++){
        if(props.listaProdutos[i].codigo != produto.codigo){
          novaLista.push(props.listaProdutos[i])
        }
      }
                ...
                <tr>
                  ...
                  <td>
                    <Button variant="warning" onClick={()=>{alterarProduto(produto);}}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-square" viewBox="0 0 16 16">
                     ...
                     <Button onClick={()=>{excluirProduto(produto);}} variant="danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
